<template>
  ...
  // Mosaïque d'images
  const mosaicImages = [
    { src: 'images/terrace-small.jpg', alt: 'Terrasse' },
    { src: 'images/lounge-small.jpg', alt: 'Salon' },
    { src: 'images/interior-small.jpg', alt: 'Intérieur'} ,
    { src: 'images/bar-small.jpg', alt: 'Bar' },
  ];
  </script>
